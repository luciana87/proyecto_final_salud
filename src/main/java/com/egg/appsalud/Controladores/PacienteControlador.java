...
public class PacienteControlador {
    ...
    public String mostrarFormularioModificar(@PathVariable String id, ModelMap model) {
        ...
        model.put("paciente", pacienteServicio.getOne(id));
    ...
    public String modificarPaciente(@PathVariable String id, String mail, String password, String nombre, String apellido,
        ...
        try {
            ...
            pacienteServicio.modificarPaciente(archivo,id, mail, password,
