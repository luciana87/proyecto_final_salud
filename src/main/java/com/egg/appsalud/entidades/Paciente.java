...
//    private List<Turno>listaDeTurnos;
    ...
    public Paciente(String id_paciente) {
        this.id_paciente = id_paciente;
    }

    public Paciente(String id_paciente, String mail, String password, String nombre, String apellido, String dni, int edad, long telefono) {
